...
// Start the session
session_start();
$scoreBoard = isset($_COOKIE['scoreboard']) ? json_decode($_COOKIE['scoreboard'], true) : [];

// Random words for the game and you to guess
$words = [
    "PROGRAMMING", "LOUISHENRY", "HAMBURGER", "INSIDIOUSLY", "MANIPULATE",
    "GEORGIASTATE", "LOLOLOLOLOLOL"
];
...
<body>
    ...
    <form method="get">
        <button id="game_back" type="submit" name="back">Back to the main page</button>
    </form>
    <a href="mode.html" id="switch_mode">switch mode</a>
    <!-- Main app display -->
    ...
    <div>
        <a href="leaderboard.php" id="leaderboard">Leader Board</a>
    </div>
